...
$sql = "SELECT * FROM orders inner join store_info on orders.store_id = store_info.store_id where orders.store_id=$storeid and owner_id=$userid";
...
<div class="table-responsive">
            <table class="table table-borderless table-hover table-striped">
               ...
               <tbody id="myTable">
                  ...
                  <?php  } ?>
                  <tr>
                      <td colspan="8" class="text-center text-success"><b>Total Amount Recieved : £ <?php echo $total_price;?></b></td>
                  </tr>
               </tbody>
            </table>
</div>
